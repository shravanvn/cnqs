...
class SpectralDifferenceProblem : public Problem<Real, GlobalOrdinal> {
public:
...
template <class Real, class LocalOrdinal, class GlobalOrdinal, class Node>
SpectralDifferenceProblem<Real, LocalOrdinal, GlobalOrdinal, Node>::
    SpectralDifferenceProblem(
        const std::shared_ptr<const Hamiltonian<Real, GlobalOrdinal>>
            &hamiltonian,
        GlobalOrdinal maxFreq,
    ...
    TEUCHOS_TEST_FOR_EXCEPTION(
        ...
        "==cnqs::pdesolver::SpectralDifferenceProblem::"
...
SpectralDifferenceProblem<Real, LocalOrdinal, GlobalOrdinal, Node>::
    ...
    TEUCHOS_TEST_FOR_EXCEPTION(
        ...
        "==cnqs::pdesolver::SpectralDifferenceProblem::ConstructMap== Could "
        "not construct a contiguous map");
...
template <class Real, class LocalOrdinal, class GlobalOrdinal, class Node>
Real SpectralDifferenceProblem<Real, LocalOrdinal, GlobalOrdinal, Node>::
